...
public class lopez_p1decryption {
	...
	public static void main(String [] args) {
		...
		while (true) {
			...
			if (length == 4) {
				...
				if      (i == 0){digitOne = (digit -7+10) % 10;}
				else if (i == 1) {digitTwo = (digit -7+10) % 10;}
				else if (i == 2) {digitThree = (digit -7+10) % 10;}
				else if (i == 3) {digitFour = (digit -7+10) % 10;}
				}
